...
for study in STUDIES:
	...
	linify('')
	linify(f'{study["done"]} of {study["total"]}, means {ceil((study["total"] - study["done"]) / days_remaining)} {study["type"]} per day or')
	linify(f'{ceil((study["total"] - study["done"]) / (days_remaining - EXAM['days_before_goal']))} {study["type"]} per day to end {EXAM['days_before_goal']} days before exam')
	linify('')
	print(separator_line)
